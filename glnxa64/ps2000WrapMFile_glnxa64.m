function [methodinfo,structs,enuminfo,ThunkLibName]=ps2000WrapMFile_glnxa64
%PS2000WRAPMFILE_GLNXA64 Create structures to define interfaces found in 'ps2000Wrap'.

%This function was generated by loadlibrary.m parser version  on Mon Jul 17 16:32:07 2017
%perl options:'ps2000Wrap.i -outfile=ps2000WrapMFile_glnxa64.m -thunkfile=ps2000Wrap_thunk_glnxa64.c -header=ps2000Wrap.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps2000Wrap_thunk_glnxa64');
% extern int16_t PollFastStreaming ( int16_t handle ); 
...
% extern void SetBuffer ( int16_t handle , int16_t channel , int16_t * buffer , uint32_t bufferSize ); 
...
% extern void SetAggregateBuffer ( int16_t handle , int16_t channel , int16_t * bufferMax , int16_t * bufferMin , uint32_t bufferSize ); 
...
% extern int16_t FastStreamingReady ( int16_t handle ); 
...
% extern uint32_t GetFastStreamingDetails ( int16_t handle , int16_t * overflow , uint32_t * triggeredAt , int16_t * triggered , int16_t * auto_stop , int16_t * appBufferFull , uint32_t * startIndex ); 
...
% extern void setEnabledChannels ( int16_t handle , int16_t * enabledChannels ); 
...
% extern void clearFastStreamingParameters ( int16_t handle ); 
...
% extern int16_t setCollectionInfo ( int16_t handle , uint32_t collectionSize , uint32_t overviewBufferSize ); 
