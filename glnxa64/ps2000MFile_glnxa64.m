function [methodinfo,structs,enuminfo,ThunkLibName]=ps2000MFile_glnxa64
%PS2000MFILE_GLNXA64 Create structures to define interfaces found in 'ps2000'.

%This function was generated by loadlibrary.m parser version  on Mon Jul 17 16:32:07 2017
%perl options:'ps2000.i -outfile=ps2000MFile_glnxa64.m -thunkfile=ps2000_thunk_glnxa64.c -header=ps2000.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps2000_thunk_glnxa64');
...
% int16_t ps2000_get_unit_info ( int16_t handle , char * string , int16_t string_length , int16_t line ); 
...
% int16_t ps2000_get_streaming_last_values ( int16_t handle , void * GetOverviewBuffersMaxMin ); 
